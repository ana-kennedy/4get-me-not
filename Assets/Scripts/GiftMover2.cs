...
public class GiftMover2 : MonoBehaviour
{
    ...
    {
        Collider2D tileCollider = Physics2D.OverlapCircle(transform.position, 0.1f, giftTileLayer);
        return tileCollider != null && tileCollider.CompareTag("GiftTile");
    }
